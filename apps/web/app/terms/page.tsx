      ...
      <div className="max-w-6xl mx-auto px-6 py-12 flex flex-col lg:flex-row gap-8">
        ...
        <aside className="lg:w-1/4 lg:sticky lg:top-8 h-fit space-y-1 max-h-[80vh] overflow-y-auto pr-2 custom-scrollbar">
          ...
          {[
            ...
            { id: "11", title: "11. SigmaSpire Marketplace & Creator Payouts" },
        ...
        <main className="lg:w-3/4 space-y-16">
          ...
          <section id="section-1" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              <p>
                By registering for, accessing, downloading, installing, or utilizing the SigmaSpire web application, mobile applications, API routes, execution engines, local or remote scripts, and associated documentation (collectively, the "Services"), you declare that you have read, understood, and agreed to be legally bound by these Terms of Service (the "Terms"). These Terms govern the relationship between you ("User", "Client", "Subscriber", "Creator") and SigmaSpire Technologies Private Limited ("SigmaSpire", "Company", "We", "Us", "Our"), a company incorporated under the Companies Act, 2013, with its registered office in Mumbai, Maharashtra, India.
              </p>
              <p>
          ...
          <section id="section-2" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-3">
                ...
                <li><strong>"API Bridging"</strong> signifies the technological linkage between SigmaSpire's secure server environments and the authorized third-party endpoints provided by SEBI-registered stockbrokers (e.g., Zerodha Kite Connect, Upstox API, Fyers API).</li>
                ...
                <li><strong>"Strategy"</strong> or <strong>"Bot"</strong> refers to a specific configuration of technical indicators, price action rules, risk management protocols, and capital allocation instructions created, copied, or purchased by the User within the SigmaSpire ecosystem.</li>
              </ul>
          ...
          <section id="section-3" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              <p>
                SigmaSpire operates exclusively as a <strong>Technology Service Provider (TSP)</strong>. The Services represent software tools designed to assist users in writing, backtesting, visualizing, and automated execution routing of stock market trading strategies. We are a software-as-a-service (SaaS) entity, providing infrastructure, server uptime, and code compilation environments.
              </p>
              <p>SigmaSpire explicitly disclaims any status as a financial intermediary. Specifically, SigmaSpire does NOT:</p>
          ...
          <section id="section-4" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>To enable live execution, you must link your own broker accounts via valid API keys. These credentials are encrypted on our servers using industry-standard AES-256-GCM configurations. By inputting these keys, you explicitly authorize SigmaSpire's servers to construct and dispatch automated trading signals on your behalf, utilizing your identity.</li>
                <li>You must immediately notify SigmaSpire's support team if you suspect any unauthorized access to your account or breach of your API keys. However, SigmaSpire bears no liability for losses resulting from compromised user credentials.</li>
              </ul>
            </div>
          </section>
          ...
          <section id="section-6" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              ...
              <p>
                When designing your algorithms on SigmaSpire, you must implement logic that avoids incessant order modification (e.g., trailing a stop loss tick-by-tick every microsecond). If your strategy breaches the exchange OTR thresholds, your broker may block your API token, disable your trading account, and pass the exchange-levied financial penalties directly to your ledger.
              </p>
              <p>
                SigmaSpire does not pre-validate or simulate OTR ratios. The responsibility for optimizing order frequency rests entirely with you. We are not liable for any OTR penalties, broker bans, or subsequent losses caused by aggressive algorithm logic.
              </p>
            </div>
          </section>
          ...
          <section id="section-7" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              <p>
                To comply with exchange rules, preserve platform stability, and prevent denial-of-service (DoS) conditions on broker servers, SigmaSpire enforces a hard, non-negotiable rate limit across its execution infrastructure.
              </p>
              <p>
          ...
          <section id="section-10" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              ...
              <p>
                Exceptions to the no-refund policy are evaluated at the sole discretion of SigmaSpire's management in cases of proven, prolonged, and complete systemic outages exceeding 72 hours.
              </p>
            </div>
          </section>

          <section id="section-11" className="scroll-mt-8 space-y-4">
            <h2 className="text-2xl font-bold text-white border-b border-[#30363D] pb-2">11. SigmaSpire Marketplace & Creator Payouts</h2>
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              <p>
                SigmaSpire operates a community Marketplace where users ("Creators") can publish, license, and monetize their proprietary trading strategies for other users ("Subscribers") to utilize.
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Revenue Split:</strong> Earnings generated from strategy subscriptions are subject to a platform service fee, detailed in the Creator Dashboard. SigmaSpire reserves the right to adjust this commission structure.</li>
                ...
                <li><strong>Compliance Audits:</strong> All payouts are subject to prior compliance audits. If a Creator is found to be utilizing deceptive titles, promising guaranteed returns, or manipulating backtest data to boost sales, SigmaSpire reserves the right to freeze their earnings, refund subscribers, and ban the Creator.</li>
              </ul>
            </div>
          </section>
          ...
          <section id="section-12" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              <p>
                The Services—including but not limited to the source code, user interfaces, design systems, AI intent-parsing engines, proprietary indicators, deployment infrastructure, logos, and trademarks—constitute the exclusive intellectual property of SigmaSpire and are protected by international copyright, patent, and trademark laws.
              </p>
              <p>
                SigmaSpire grants you a limited, non-exclusive, non-transferable, non-sublicensable, revocable license to access and use the platform strictly for personal or internal business operations in accordance with your subscription tier.
              </p>
              <p>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Resell, lease, white-label, or package SigmaSpire's services as your own product without a formal enterprise agreement.</li>
              </ul>
            </div>
          </section>
          ...
          <section id="section-13" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              <p>
                <strong>Your Strategies:</strong> Any strategy, algorithm, or mathematical logic built, uploaded, or configured by you in the Strategy Builder remains your exclusive intellectual property. SigmaSpire does not claim ownership over your proprietary alpha. We employ encryption and strict access controls to ensure our staff cannot access your private strategy parameters.
              </p>
              <p>
                <strong>Marketplace License:</strong> If you explicitly choose to publish a strategy to the public SigmaSpire Marketplace, you grant SigmaSpire a worldwide, royalty-free, sublicensable license to host, display, advertise, and route subscription signals for that strategy on your behalf.
              </p>
              <p>
                <strong>Non-Infringement:</strong> You represent and warrant that any custom logic you deploy or publish does not infringe upon the patents, copyrights, or trade secrets of any third-party quantitative firm or individual. SigmaSpire complies with DMCA and local copyright takedown notices and will swiftly remove infringing algorithms.
              </p>
            </div>
          </section>
          ...
          <section id="section-14" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Deploying algorithms specifically designed to test the limits, break, or execute Denial of Service (DoS) attacks on SigmaSpire's infrastructure or the infrastructure of connected stock brokers.</li>
          ...
          <section id="section-15" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              <p>
                SigmaSpire strictly prohibits the use of its infrastructure for any form of illegal market manipulation. You agree that your algorithms will not be designed or deployed to execute:
              </p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <section id="section-16" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              <p>
                The core functionality of SigmaSpire relies on bridging to third-party brokerage APIs. Your relationship with your broker is governed entirely by their terms of service, which supersede these Terms regarding actual trade execution.
              </p>
              <p>
                SigmaSpire is not affiliated with, endorsed by, or legally partnered with these brokers unless explicitly stated. If a broker alters their API structure, revokes your API access, changes their pricing, or experiences a massive server outage on their end, SigmaSpire's service will subsequently fail to execute your trades. We disclaim all liability for any losses, missed opportunities, or damages arising from the failure, deprecation, or alteration of third-party broker APIs.
              </p>
            </div>
          </section>
          ...
          <section id="section-17" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              <p className="italic font-bold">
                THE SERVICES ARE PROVIDED ON AN "AS IS", "AS AVAILABLE", AND "WITH ALL FAULTS" BASIS. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, SIGMASPIRE EXPLICITLY DISCLAIMS ALL WARRANTIES, WHETHER EXPRESS, IMPLIED, STATUTORY, OR OTHERWISE, INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TIMELINESS, NON-INFRINGEMENT, AND ACCURACY.
              </p>
          ...
          <section id="section-18" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              <p className="uppercase font-bold text-red-400">
                IN NO EVENT SHALL SIGMASPIRE, ITS DIRECTORS, FOUNDERS, EMPLOYEES, AGENTS, AFFILIATES, OR PARTNERS BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF TRADING CAPITAL, PROFITS, REVENUE, DATA, GOODWILL, OR USE, INCURRED BY YOU OR ANY THIRD PARTY, REGARDLESS OF THE THEORY OF LIABILITY (CONTRACT, TORT, STRICT LIABILITY, OR OTHERWISE), EVEN IF SIGMASPIRE HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
              </p>
              ...
              <p className="font-bold">
                In all cases, irrespective of the nature of the claim, SigmaSpire's maximum cumulative financial liability under these terms is strictly capped at the total subscription fees actually paid by you to SigmaSpire during the three (3) months immediately preceding the event giving rise to the liability.
              </p>
            </div>
          </section>
          ...
          <section id="section-19" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              <p>
                You agree to unconditionally defend, indemnify, and hold harmless SigmaSpire, its affiliates, directors, officers, employees, contractors, and agents from and against any and all claims, damages, obligations, losses, liabilities, regulatory fines, costs, or debt, and expenses (including but not limited to attorney's fees) arising directly or indirectly from:
              </p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <section id="section-21" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              ...
              <p>
                <strong>Termination by SigmaSpire:</strong> We reserve the right to instantly suspend or permanently terminate your account, without notice or refund, if we determine in our sole discretion that you have violated these Terms, engaged in market manipulation, abused our infrastructure, or pose a legal or regulatory risk to the platform.
              </p>
              <p>
          ...
          <section id="section-22" className="scroll-mt-8 space-y-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed">
              ...
              <p>
                You and SigmaSpire agree that any dispute resolution proceedings will be conducted only on an individual basis and not in a class, consolidated, or representative action.
              </p>
            </div>
          </section>
        </main>
