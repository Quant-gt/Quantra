...
export default function SocialFeedPage() {
  ...
  // Construct dynamic posts from database strategies
    ...
    <div className="max-w-3xl mx-auto py-6 pb-20">
      ...
      <div className="space-y-6">
        {posts.length > 0 ? (
          ...
          <div className="bg-[#161B22]/60 border border-[#30363D] rounded-xl p-12 text-center text-gray-400 backdrop-blur-xl">
            <MessageCircle size={36} className="mx-auto mb-4 text-[#58A6FF] opacity-75" />
            <h4 className="font-bold text-white text-lg mb-2">No updates found</h4>
            <p className="text-xs max-w-sm mx-auto leading-relaxed">
              No live strategy signals or performance reports are currently active in your feed. Follow strategy creators in the marketplace to see updates here.
            </p>
          </div>
        )}
      </div>
